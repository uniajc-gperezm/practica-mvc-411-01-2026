...
public class Main {
    public static void main(String[] args) {
        ...
        // Creando estudiante desde su modelo
        Estudiante estudiante = new Estudiante(1, "Juan Perez", 25);

        // Creando la vista de estudiante
        VistaEstudiante vista = new VistaEstudiante();

        // Creando el controlador de estudiante y vinculandolo con la vista y el modelo
